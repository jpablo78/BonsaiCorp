"""Deterministic greedy constructor for fast feasible comparison scenarios."""
...
def greedy_cover_assignment(
    ...
    *,
    ...
    """Cover compatible products greedily, prioritizing annual-volume coverage.

    This is a feasible warm-start/benchmark, not a replacement for the CP-SAT
    model because it does not optimize the tier interactions globally.
    """
