...
- `run_highs_benchmark.py`: comparación opcional de código abierto.
- `run_decimal_scip.py`: ruta decimal de código abierto con OR-Tools/SCIP.
- `build_headspace_ab_probe.py`: genera una entrega controlada que cambia
